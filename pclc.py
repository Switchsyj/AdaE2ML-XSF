...
import random
import numpy as np
from model.pclc_tagger import BinarySLUTagger, SentRepreGenerator, ContrastivePredictor, FinalSlotNamePredictor
...
class Trainer(object):
    ...
    def train_epoch(self, ep):
        ...
        for i, batch_train_data in enumerate(self.train_loader):
            ...
            type_loss, con_loss, context_loss = self.slotname_predictor(domains, lstm_hiddens, length, binary_golds=bio_label, final_golds=slu_label)
            
            loss_slotname = type_loss + 0.1 * con_loss + 0.1 * context_loss
            self.optimizer.zero_grad()
    ...
    def evaluate(self, test_loader):
        ...
        with torch.no_grad():
            for _, batch_test_data in enumerate(test_loader):
                ...
                length = token_mask.sum(-1)
                slotname_preds_batch = self.slotname_predictor(domains, lstm_hiddens, length, binary_preditions=bin_preds_batch, binary_golds=None, final_golds=None)
...
if __name__ == '__main__':
    ...
    random_seeds = [4096, 1314, 2019, 2020, 2021, 2022, 2023]
...
# nohup python pclc.py --cuda 0 -lr 5e-4 --n_sample 0 --batch_size 64 --tgt_dm AddToPlaylist --freeze_emb --tr --epoch 300 --emb_dim 400 --dropout 0.3 --hidden_size 200 --num_rnn_layer 2 --patient 15 --emb_file data/snips/cache/slu+slot_word_char.npy --slot_emb_file data/snips/cache/slot_word_char.dict --model_ckpt ckpt/pclc/pclc_atp0.ckpt --vocab_ckpt ckpt/pclc/pclc_atp0_vocab.ckpt &> training_log/pclc/baseline_atp0.log &
# nohup python pclc.py --cuda 2 -lr 5e-4 --n_sample 0 --batch_size 64 --tgt_dm BookRestaurant --freeze_emb --tr --epoch 300 --emb_dim 400 --dropout 0.3 --hidden_size 200 --num_rnn_layer 2 --patient 15 --emb_file data/snips/cache/slu+slot_word_char.npy --slot_emb_file data/snips/cache/slot_word_char.dict --model_ckpt ckpt/pclc/pclc_br0.ckpt --vocab_ckpt ckpt/pclc/pclc_br0_vocab.ckpt &> training_log/pclc/baseline6_br0.log & 
# nohup python pclc.py --cuda 1 -lr 5e-4 --n_sample 0 --batch_size 64 --tgt_dm GetWeather --freeze_emb --tr --epoch 300 --emb_dim 400 --dropout 0.3 --hidden_size 200 --num_rnn_layer 2 --patient 15 --emb_file data/snips/cache/slu+slot_word_char.npy --slot_emb_file data/snips/cache/slot_word_char.dict --model_ckpt ckpt/pclc/pclc_gw0.ckpt --vocab_ckpt ckpt/pclc/pclc_gw0_vocab.ckpt &> training_log/pclc/baseline1_gw0.log &
# nohup python pclc.py --cuda 1 -lr 5e-4 --n_sample 0 --batch_size 64 --tgt_dm PlayMusic --freeze_emb --tr --epoch 300 --emb_dim 400 --dropout 0.3 --hidden_size 200 --num_rnn_layer 2 --emb_file data/snips/cache/slu+slot_word_char.npy --slot_emb_file data/snips/cache/slot_word_char.dict --model_ckpt ckpt/pclc/pclc_pm0.ckpt --vocab_ckpt ckpt/pclc/pclc_pm0_vocab.ckpt &> training_log/pclc/baseline_pm0.log &
# nohup python coach.py --cuda 0 -lr 5e-4 --n_sample 0 --tgt_dm RateBook --freeze_emb --tr --epoch 300 --emb_dim 400 --dropout 0.3 --hidden_size 200 --num_rnn_layer 2 --emb_file data/snips/cache/revised/slu+slot_word_char.npy --slot_emb_file data/snips/cache/revised/slot_word_char.dict --model_ckpt ckpt/debug.ckpt --vocab_ckpt ckpt/debug_vocab.ckpt &> training_log/coach/baseline_rb0.log & 
# nohup python coach.py --cuda 0 -lr 5e-4 --n_sample 0 --tgt_dm SearchCreativeWork --freeze_emb --tr --epoch 300 --emb_dim 400 --dropout 0.3 --hidden_size 200 --num_rnn_layer 2 --emb_file data/snips/cache/revised/slu+slot_word_char.npy --slot_emb_file data/snips/cache/revised/slot_word_char.dict --model_ckpt ckpt/debug.ckpt --vocab_ckpt ckpt/debug_vocab.ckpt &> training_log/coach/baseline_scw0.log & 
