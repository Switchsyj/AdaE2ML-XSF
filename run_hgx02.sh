...
nohup python slu_e2e_bert_domain_unseen_train.py --cuda 0 -lr 1e-3 --n_sample 0 --tgt_dm AddToPlaylist --epoch 30 --dropout 0.1 --model_ckpt testlog/test_atp.ckpt --vocab_ckpt testlog/test_vocab.ckpt &> testlog/bert_domain_adalabel_vaebertlr_atp0.log &
nohup python slu_e2e_bert_domain_unseen_train.py --cuda 0 -lr 1e-3 --n_sample 0 --tgt_dm BookRestaurant --epoch 30 --dropout 0.1 --model_ckpt testlog/test_br.ckpt --vocab_ckpt testlog/test_vocab.ckpt &> testlog/bert_domain_adalabel_vaebertlr_br0.log &
nohup python slu_e2e_bert_domain_unseen_train.py --cuda 1 -lr 1e-3 --n_sample 0 --tgt_dm GetWeather --epoch 30 --dropout 0.1 --model_ckpt testlog/test_gw.ckpt --vocab_ckpt testlog/test_vocab.ckpt &> testlog/bert_domain_adalabel_vaebertlr_gw0.log &
nohup python slu_e2e_bert_domain_unseen_train.py --cuda 1 -lr 1e-3 --n_sample 0 --tgt_dm PlayMusic --epoch 30 --dropout 0.1 --model_ckpt testlog/test_pm.ckpt --vocab_ckpt testlog/test_vocab.ckpt &> testlog/bert_domain_adalabel_vaebertlr_pm0.log &
nohup python slu_e2e_bert_domain_unseen_train.py --cuda 2 -lr 1e-3 --n_sample 0 --tgt_dm RateBook --epoch 30 --dropout 0.1 --model_ckpt testlog/test_rb.ckpt --vocab_ckpt testlog/test_vocab.ckpt &> testlog/bert_domain_adalabel_vaebertlr_rb0.log &
nohup python slu_e2e_bert_domain_unseen_train.py --cuda 2 -lr 1e-3 --n_sample 0 --tgt_dm SearchCreativeWork --epoch 30 --dropout 0.1 --model_ckpt testlog/test_scw.ckpt --vocab_ckpt testlog/test_vocab.ckpt &> testlog/bert_domain_adalabel_vaebertlr_scw0.log &
nohup python slu_e2e_bert_domain_unseen_train.py --cuda 3 -lr 1e-3 --n_sample 0 --tgt_dm SearchScreeningEvent --epoch 30 --dropout 0.1 --model_ckpt testlog/test_sse.ckpt --vocab_ckpt testlog/test_vocab.ckpt &> testlog/bert_domain_adalabel_vaebertlr_sse0.log &
