...
from utils.snips_e2ebert_datautil import load_data, create_vocab, batch_variable, save_to
...
class Trainer(object):
    ...
    def train_epoch(self, ep=0):
        ...
        for i, batch_train_data in enumerate(self.train_loader):
            ...
            logger.info('[Epoch %d] Iter%d time cost: %.4fs, loss: %.4f, binary_loss: %.4f, slu_loss: %.4f' % \
                (ep, i, (time.time() - t1), loss.item(), loss_tr["bio_loss"], loss_tr["slu_loss"]))       
        return loss_tr
...
# train
# nohup python slu_e2e_bert_train.py --cuda 0 -lr 1e-3 --n_sample 0 --tgt_dm AddToPlaylist --epoch 20 --dropout 0.3 --model_ckpt ckpt/end2end/bert_prefixorth_atp0.ckpt &> training_log/end2end/bert_prefixorth_atp0.log &
# nohup python slu_e2e_bert_train.py --cuda 1 -lr 1e-3 --n_sample 0 --tgt_dm BookRestaurant --epoch 20 --dropout 0.3 --model_ckpt ckpt/end2end/bert_prefixorth_br0.ckpt &> training_log/end2end/bert_prefixorth_br0.log &
# nohup python slu_e2e_bert_train.py --cuda 2 -lr 1e-3 --n_sample 0 --tgt_dm GetWeather --epoch 20 --dropout 0.3 --model_ckpt ckpt/end2end/bert_prefixorth_gw0.ckpt &> training_log/end2end/bert_prefixorth_gw0.log &
# nohup python slu_e2e_bert_train.py --cuda 3 -lr 1e-3 --n_sample 0 --tgt_dm PlayMusic --epoch 20 --dropout 0.3 --model_ckpt ckpt/end2end/bert_prefixorth_pm0.ckpt &> training_log/end2end/bert_prefixorth_pm0.log &
# nohup python slu_e2e_bert_train.py --cuda 4 -lr 1e-3 --n_sample 0 --tgt_dm RateBook --epoch 20 --dropout 0.3 --model_ckpt ckpt/end2end/bert_prefixorth_rb0.ckpt &> training_log/end2end/bert_prefixorth_rb0.log &
# nohup python slu_e2e_bert_train.py --cuda 5 -lr 1e-3 --n_sample 0 --tgt_dm SearchCreativeWork --dropout 0.3 --epoch 20 --model_ckpt ckpt/end2end/bert_prefixorth_scw0.ckpt &> training_log/end2end/bert_prefixorth_scw0.log &
# nohup python slu_e2e_bert_train.py --cuda 6 -lr 1e-3 --n_sample 0 --tgt_dm SearchScreeningEvent --epoch 20 --dropout 0.3 --model_ckpt ckpt/end2end/bert_prefixorth_sse0.ckpt --vocab_ckpt ckpt/end2end/bert_prefixorth_sse0_vocab.ckpt &> training_log/end2end/bert_prefixorth_sse0.log &
